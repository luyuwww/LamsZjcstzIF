...
public class GlobalFinalAttr implements Serializable {
	...
	public enum DatabaseType{
		...
		public String generateDateToSQLDate(Object date){
			TimeZone.setDefault(TimeZone.getTimeZone("ETC/GMT-8"));  //设置时区 中国/北京/香港
			String datevalue = null;
			if(date instanceof Date){
				datevalue = DateUtil.getDateTimeFormat().format(date);
			...
			case 1:
				...
				break;
			case 2:
				datevalue =  "DATE_FORMAT('"+datevalue+"', '%Y-%m-%d')";
				break;
			case 3:
				datevalue = "TIMESTAMP('" + datevalue + "' )";
				break;
			case 4:
				datevalue = "PARSEDATETIME('" + datevalue + "'，'dd-MM-yyyy' )";
				break;
			}
			return datevalue;
		}
	...
	/** 流程节点向外发送消息 sendMsg*/
	public static String SEND_OUT_ACTIVITI_MSG = "sendMsg";
	 /** 手动催还外发邮件或者消息 borrowMailreminderWillExpire*/
	public static String SEND_MAIL_4_CUIHUAN = "sendEmailToCuihuan";
	 /** 自动发送邮件或消息提醒用户按时归还 borrowMailreminderWillExpire*/
	public static String SEND_MAIL_MAIL_4_WILL = "borrowMailreminderWillExpire";
	/** 流程完成的时候发送摧毁消息的地址  sendDestoryMsg*/
	public static String SEND_DESTROY_MSG = "sendDestoryMsg";
	
	public static final String ESB_CREATED = "created";//增加
	public static final String ESB_MODIFIED = "modified";//更新
	public static final String ESB_DELETED = "deleted";//删除
	
	public static final String ESB_RY = "RL_RY";// 人员
	public static final String ESB_BM = "RL_BM";// 部门
	public static final String ESB_XM = "XM_XM"; //项目 
	public static final String ESB_XMGH = "vIEW_xmgh"; //项目 
	public static final String LAMS_LOG = "LAMS_LOG"; //系统内部日志
	
	/** MAX_XML_SIZE:最大的xml尺寸是30M*/
	public static final Long MAX_XML_SIZE = 30L*1024L*1024L; 
}
